...
- If you are familiar with the structure of `values-config.yaml`, edit it directly
    - `general.license`: as a minimum, fill in `activationKey` and set `accepted` to `true`; add license keys for LDAP and Directory Integrator if you with to deploy these
